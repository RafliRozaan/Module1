...
if bg_image is None:
    st.session_state.y_axis_scale = widgets["y_axis_scale"]
    st.session_state.y_min_value = widgets["y_min_value"]
    st.session_state.y_max_value = widgets["y_max_value"]
    st.session_state.h_line_min_position = widgets["h_line_min_position"]
    st.session_state.h_line_max_position = widgets["h_line_max_position"]
    st.session_state.x_axis_scale = widgets["x_axis_scale"]
    st.session_state.x_min_value = widgets["x_min_value"]
